...
folder_path = 'E:\Workspace\Thejoeun\PROJECT\COVID-19-master\csse_covid_19_data\csse_covid_19_daily_reports'  #폴더 경로 지정
...
search_month = ['2023-02', '2023-03', '2023-04']  #수색할 월 리스트

filtered_data = []
for df in corona19:
    filtered_df = df[df[column_name] == search_name]
    filtered_df = filtered_df.loc[:, ['Last_Update','Confirmed', 'Deaths']]
    filtered_df = filtered_df[filtered_df['Last_Update'].isin(search_month)]
